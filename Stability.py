...
ir0 = 0.9e-3 #04.00e-3 #1.8e-3/2 # # distacne to pole from trap centre in m
iz0 = 1.4e-3 #16.653e-3 #2.8e-3/2 # # distance to end caps from trap centre m
iVac = 830 #830 # # RF voltage V
iVdc = 130 #130 # # DC volatage V
