...
ax.set(xlabel='$u$ [mm]',ylabel='$\\phi$ [V]',title='Potential due to RF voltage')
ax.legend(loc='upper right')

alpha_xAC = -vals[0]*r0**2
print(f'alpha_u^AC = {abs(alpha_xAC):.4f}')
...
ax.set(xlabel='$v$ [mm]',ylabel='$\\phi$ [V]',title='Potential due to RF voltage')
ax.legend(loc='upper right')

alpha_yAC = vals[0]*r0**2
print(f'alpha_v^AC = {abs(alpha_yAC):.4f}')
print('--------------------------------------------------')
