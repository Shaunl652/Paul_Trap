...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  3 15:20:49 2024
...
lc = 1#e-2
gmsh.model.geo.addPoint(-6, -6, 0, lc, 1)
...
# tags:
gmsh.model.geo.addPoint(-6, +6, 0, lc, 2)
gmsh.model.geo.addPoint(+6, +6, 0, lc, 3)

# If the tag is not provided explicitly, a new tag is automatically created, and
# returned by the function:
p4 = gmsh.model.geo.addPoint(+6, -6, 0, lc)
